...
async function fetchAllEntries(railId: string | undefined): Promise<AuditLogEntry[]> {
  ...
  for (let page = 0; page < EXPORT_MAX_PAGES; page++) {
    const res = railId
      ? await adminApi.getEntityAuditLog(railId, page, EXPORT_PAGE_SIZE)
      : await adminApi.getAuditLog(page, EXPORT_PAGE_SIZE)
    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs px-2.5 py-1 rounded-lg bg-blue-50 text-blue-700 hover:bg-blue-100 disabled:opacity-50"
        >
